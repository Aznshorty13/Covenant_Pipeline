...
| [Math for Containerization.md](Math%20for%20Containerization.md) | $Y^D$, $eval$, internalization |
| [Math for Platform Engineer.md](Math%20for%20Platform%20Engineer.md) | Broader platform math (IaC, CI/CD) |
